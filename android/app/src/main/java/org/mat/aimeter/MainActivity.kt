...
import org.mat.aimeter.core.Payload
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MaterialTheme {
                Surface {
                    AiMeterScreen(activity = this, onRetry = ::retrySubscribe)
                }
            }
        }
    }
    ...
    // Prefs are written from AiMeterMessagingService, a different component, so the
...
@Composable
private fun AiMeterScreen(activity: MainActivity, onRetry: () -> Unit) {
